from sqlalchemy import Column, String, BigInteger, CheckConstraint, ForeignKey
...
class ClienteOrm(Base):
    ...
    numero_cedula = Column(BigInteger, CheckConstraint('numero_cedula >= 0'), nullable=False, unique=True)
    email_cliente = Column(String(50), nullable=False, unique=True)
    numero_telefono = Column(BigInteger, CheckConstraint('numero_telefono >= 0'))
